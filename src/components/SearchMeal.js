...
const SearchMeal = (props) => {
    return ( 
        ...
        <div className="items-search">
            <div className="col-3 col-md-2 items-search--center">
            ...
            {/* info */}
            <div className="col-1 col-md-2 search-more-info-container">
            ...
            {/* check */}
            <div className="col-1 col-md-1 check-container check-container--search" onClick={() => props.checkedMeal(props.id)}>
                {props.isChecked ?
